const rows = [
  { id: "P-1001", name: "Kasun Perera", email: "kasun@example.com", status: "Active" },
  { id: "P-1002", name: "Nimali Silva", email: "nimali@example.com", status: "Active" },
  { id: "P-1003", name: "Tharindu Jay", email: "tharindu@example.com", status: "Pending" },
];

export const metadata = {
  title: "Patient Management | Admin",
};
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--text-gray)" }}>
            Search, view, and manage patient accounts.
          </p>
        </div>
        ...
        <div className="divide-y" style={{ borderColor: "var(--soft-blue)" }}>
          {rows.map((r) => (
            <div key={r.id} className="grid grid-cols-12 gap-3 px-5 py-4 text-sm">
              ...
              <div className="col-span-4" style={{ color: "var(--text-gray)" }}>
                {r.email}
              </div>
              <div className="col-span-1 text-right">
                <span
                  ...
                  style={{
                    ...
                    color: r.status === "Active" ? "var(--primary-blue)" : "var(--text-gray)",
